...
{
    r.register_handler("tempo.add_point", [s](auto& req, auto& resp) {
    ...
    r.register_handler("tempo.remove_point", [s](auto& req, auto& resp) {
    ...
    r.register_handler("tempo.list_points", [s](auto&, auto& resp) {
    ...
    r.register_handler("tempo.update_point", [s](auto& req, auto& resp) {
