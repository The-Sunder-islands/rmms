...
{
    r.register_handler("arranger.add_section", [s](auto& req, auto& resp) {
    ...
    r.register_handler("arranger.remove_section", [s](auto& req, auto& resp) {
    ...
    r.register_handler("arranger.list_sections", [s](auto&, auto& resp) {
    ...
    r.register_handler("arranger.update_section", [s](auto& req, auto& resp) {
