...
{
    r.register_handler("mixer.list_channels", [s](auto&, auto& resp) {
    ...
    r.register_handler("mixer.add_channel", [s](auto& req, auto& resp) {
    ...
    r.register_handler("mixer.remove_channel", [s](auto& req, auto& resp) {
    ...
    r.register_handler("mixer.set_volume", [s](auto& req, auto& resp) {
    ...
    r.register_handler("mixer.set_pan", [s](auto& req, auto& resp) {
    ...
    r.register_handler("mixer.set_route", [s](auto&, auto& resp) {
